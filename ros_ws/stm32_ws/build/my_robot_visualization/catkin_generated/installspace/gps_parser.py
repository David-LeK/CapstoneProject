...
def parse_rmc_sentence(rmc_sentence):
    ...
    publish_topic('latitude', str(latitude))
    publish_topic('longitude', str(longitude))
    publish_topic('speed_kmh', str(speed_kmh))
    ...
    publish_topic('easting', str(easting))
    publish_topic('northing', str(northing))

...
if __name__ == '__main__':
    ...
    rospy.Subscriber('latitude', String, latitude_callback)
    rospy.Subscriber('longitude', String, longitude_callback)
    rospy.Subscriber('speed_kmh', String, speed_kmh_callback)
    rospy.Subscriber('track_angle', String, track_angle_callback)
    rospy.Subscriber('easting', String, easting_callback)
    rospy.Subscriber('northing', String, northing_callback)

...
To launch the ublox_gps node with a .yaml configuration file that matches your device and settings, you can use roslaunch command with the name of your .yaml file as an argument. For example, if your .yaml file is named c94_m8p_rover.yaml and it is located in ublox_gps/config folder1, you can use this command:
```
...
You can also subscribe to some services to set or get parameters from the device2. For example,
```
